export const PRODUCT_CATEGORIES = ['T-Shirts', 'Hoodies', 'Sweatshirts', 'Pants', 'Jeans', 'Jackets', 'Shirts', 'Accessories'] as const
...
const categoryAliases: Record<string, typeof PRODUCT_CATEGORIES[number]> = { 't-shirts': 'T-Shirts', 't-shirt': 'T-Shirts', tshirts: 'T-Shirts', tshirt: 'T-Shirts', hoodies: 'Hoodies', sweatshirts: 'Sweatshirts', pants: 'Pants', jeans: 'Jeans', jackets: 'Jackets', shirts: 'Shirts', accessories: 'Accessories' }
