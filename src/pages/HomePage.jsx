  ...
  return (
    <main id="top">
      <section className="hero">
        ...
        <div className="hero-visual">{heroProduct && <img src={assetUrl(heroProduct.images?.[0])} alt={`${heroProduct.name} porté`} />}<div className="hero-sticker">The<br />Alchemist<br />Store</div><p className="hero-caption">Sélection actuelle <span>01 / 06</span></p></div>
      </section>
